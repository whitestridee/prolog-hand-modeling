...
\begin{itemize}
	\item Python (v.3.9\cite{web:python}) для написания интерфейса программы и отрисовки рук. Python был выбран в связи с наличием опыта работы с ним, что ускорило процесс разработки, а также наличии всех необходимых инструментов для отрисовки и создания GUI в нем;
