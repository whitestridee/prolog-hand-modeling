...
\hspace{0.6cm} Каждый из проверяемых углов продемонстрированы на рисунках \ref{fig:finger_motion_type_1} - \ref{fig:finger_motion_type_3}. Для демонстрации был взят только указательный и большой пальци, потому что углы у указательного, среднего, безымянного и мизинца совпадают, следовательно достаточно показать только один палец.

\begin{figure}[H]
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{большой1.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{большойP1P2Wrist.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{большой2.png}}
\end{minipage}
...
\begin{figure}[H]
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP1P2P3.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP2P3P4.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP4P2Wrist.png}}
\end{minipage}
\begin{minipage}[h]{1\linewidth}
\begin{tabular}{p{0.32\linewidth}p{0.32\linewidth}p{0.32\linewidth}}
\centering а) & \centering б) & \centering в) \\
...
\begin{figure}[H]
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP2P1P3.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP4P2P3.png}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.9\linewidth]{УказательныйP4P3Wrist.png}}
\end{minipage}
\begin{minipage}[h]{1\linewidth}
\begin{tabular}{p{0.32\linewidth}p{0.32\linewidth}p{0.32\linewidth}}
\centering а) & \centering б) & \centering в) \\
